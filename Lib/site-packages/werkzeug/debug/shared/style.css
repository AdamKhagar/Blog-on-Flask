...
div.traceback, div.plain { border: 2px solid #ddd; margin: 0 0 1em 0; padding: 10px; }
div.plain p      { margin: 0; }
div.plain textarea,
div.plain pre { margin: 10px 0 0 0; padding: 4px;
                background-color: #E8EFF0; border: 2px solid #D3E7E9; }
...
pre.console { border: 2px solid #ccc; background: white!important;
...
pre.console div.box { margin: 5px 10px; white-space: normal;
                      border: 2px solid #11557C; padding: 10px;
...
pre.console div.traceback pre.syntaxerror { background: inherit; border: none;
                                            ...
                                            padding: 10px; border-top: 2px solid #BFDDE0;
                                            background: #E8EFF0; }
...
div.console { border: 2px solid #ccc; padding: 4px; background-color: #fafafa; }
